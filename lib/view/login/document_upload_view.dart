...
class DocumentDetailView extends StatefulWidget {
  ...
  const DocumentDetailView({super.key, required this.title});

  @override
  State<DocumentDetailView> createState() => _ChangeLanguageViewState();
}

class _ChangeLanguageViewState extends State<DocumentDetailView> {
  List documentList = [
    {
